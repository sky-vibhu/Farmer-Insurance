...
// impl<T: frame_system::Config> pallet_farm_insurance::WeightInfo for WeightInfo<T> {
	pub struct FarmWeightInfo<T>(PhantomData<T>);
	impl<T: frame_system::Config> crate::WeightInfo for FarmWeightInfo<T> {
	...
	fn register_farmer() -> Weight {
		...
		//  Measured:  `6`
		//  Estimated: `4982`
		// Minimum execution time: 21_202_000 picoseconds.
